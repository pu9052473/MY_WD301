...
// this is using for creating a new task
...
export const addTask = async (
  ...
  try {
    ...
    dispatch({ type: TaskListAvailableAction.CREATE_TASK_REQUEST }); // we use this only for change the state of the component
    ...
    refreshTasks(dispatch, projectID); // after create,we use this to again fetch the tasks from the API
  } catch (error) {
...
// this is use for fetching the tasks from an API
...
// this is useing for deleting the tasks
export const deleteTask = async (
  ...
  try {
    ...
    refreshTasks(dispatch, projectID); // after delete,we use this to again fetch the tasks from the API
  } catch (error) {
    console.error("Operation failed:", error);
    dispatch({
...
// this is using for update the tasks
