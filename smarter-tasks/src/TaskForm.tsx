...
// }
 ...
 const TaskForm = (props:TaskFormProps) => {
  ...
  function uniqueID() { // we create this for give unique "id" to every task
  ...
  return <>
     <form onSubmit={addTask}>
          <div className="flex mx-auto w-[40vw] justify-between mt-5 mb-2">
            <input type="text" id="todoTitle" value={formState.title} onChange={titleChanged} placeholder="Enter The Task" required  className=" w-[14.5vw] rounded-md border-blue-500 px-1.5 border-b-2 text-lg  placeholder-slate-600 focus:outline-none"/>
            <input id="todoDescription" value={formState.description} onChange={descriptionChanged} placeholder="Enter description" required className="w-[14.5vw] rounded-md border-blue-500 px-1.5 border-b-2 text-lg  placeholder-slate-600 focus:outline-none" />
            <input type="date" id="todoDueDate" value={formState.dueDate} onChange={dueDateChanged} required className="rounded-md border-blue-500 border-b-2 text-slate-600 focus:outline-none"/>
          </div>
            <button type="submit" id="addTaskButton" className="flex mx-auto rounded-md border-2 bg-blue-300 border-blue-500 px-1.5 text-lg justify-center text-blue-700 focus:outline-none">Add items</button>
        </form>
  </>
